...
const setupDataKey = "specternevergiveup";
const accountDataKey = "commusui";
...
export const AccountDropdown: React.FC<AccountDropdownProps> = ({ onAccountsChange }) => {
    ...
    async function completeZkLogin() {
        ...
        const saltResponse: { salt: string } | null =
            await fetch(config.URL_SALT_SERVICE, requestOptions)
                ...
                .catch((error: unknown) => {
                    console.warn("[completeZkLogin] salt service error:", error, config.URL_SALT_SERVICE);
                    return null;
                });
